...
@Component({
  selector: 'app-superieure-reservation',
  templateUrl: './superieure-reservation.component.html',
  styleUrls: ['./superieure-reservation.component.css'],
  providers: [DatePipe]  // Ensure DatePipe is listed in providers
})
export class SuperieureReservationComponent {
